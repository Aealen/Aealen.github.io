...
function(t, e, n) {
    ...
    l = function(t) {
        ...
        default.directions[this.direction].name + "_step"), this.once("animationcomplete",
            function() {
                t.moveForward(),
...
default = function(t, e, n) {
        var r = -1;
        return o.
    default.getNeighbours(e, n).forEach(function(e, n) { - 1 === r && (void 0 === t[e.i] || void 0 === t[e.i][e.j] || t[e.i][e.j] || (r = n))
        }),
        r
    }
},
function(t, e, n) {
    ...
    var i = function(t) {
        function e(e, n, o, r) {
            var i = this,
            s = e.getPosition(n, o); (i = t.call(this, e, s.x, s.y, r, 0, 360, !1, 0, 1) || this).i = n,
            i.j = o,
            i.r = r,
            i.isWall = !1;
...
function(t, e, n) {
    ...
    var i = function(t) {
        function e(e) {
            ...
            "center" === e.game.myConfig.statusBarAlign && (n.setX(e.game.canvas.width / 2), n.setOrigin(.5, 0)),
            n.setPadding(o, o, o, o),
            n
        }
        return r(e, t),
 ...
 */
    ...
    a.prototype = {
        ...
        dispatchEvent: function(t) {
            for (var e = t.type,
            n = this._eventListeners[e] || [], o = 0; o < n.length; o++)"function" == typeof n[o] ? n[o].call(this, t) : n[o].handleEvent(t);
    ...
    var d = {
        ...
        _setResponseHeaders: function(t) {
            ...
            t) t.hasOwnProperty(e) && (this.responseHeaders[e] = t[e]);
